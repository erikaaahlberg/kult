...
export default function SingleEditableBooking(props){
  const { updateSelectedBookingInState, selectedBooking, sendUpdatedBookingToDatabase } = props;
  return(
    <div>
      <form>
      <h2>Bokning:</h2>
        <p>
          ...
          <input
            ...
            name="update_date" id="update_date"
        ...
        <button onClick={sendUpdatedBookingToDatabase}>Klar</button>
      </form>
    </div>
  )
};
